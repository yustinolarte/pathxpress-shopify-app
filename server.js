            ...
            ? `
              <div class="kpi-grid">
                ...
                <div class="kpi-card band">
                  ...
                  <div class="kpi-sub" style="position:relative;">to be reconciled</div>
                </div>
              </div>
...
<body>
    ...
    <form id="settingsForm">
        ...
        <div class="card">
            ...
            <p class="field-help">Default service applied to all orders from this store.</p>
        </div>
...
app.get("/app/stuck-orders", requireSessionToken, async (req, res) => {
    ...
    try {
        ...
        // Orders fulfilled but no delivered event sent
        const [noDeliveredRows] = await db.execute(
            `SELECT s.id, s.shop_order_name, s.waybill_number, s.created_at,
             ...
             LEFT JOIN orders o ON (o.waybillNumber = s.waybill_number AND o.clientId = ?)
             WHERE s.shop_domain = ?
               AND s.shopify_fulfillment_id IS NOT NULL AND s.shopify_fulfillment_id != ''
               AND s.shopify_delivered_at IS NULL
